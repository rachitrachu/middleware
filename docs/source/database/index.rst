...
X-NAS configuration database is stored in `/data/freenas-v1.db`. It is a SQLite database file containing all system
...
Different X-NAS releases might have different database table structures. While upgrading a X-NAS installation to a
