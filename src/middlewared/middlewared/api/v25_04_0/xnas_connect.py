...
__all__ = [
    ...
    'XnasConnectGetRegistrationUriResult', 'XnasConnectUpdateArgs',
    'XnasConnectUpdateResult', 'XnasConnectGenerateClaimTokenArgs',
    'XnasConnectGenerateClaimTokenResult', 'XnasConnectIpChoicesArgs',
    'XnasConnectIpChoicesResult',
]
