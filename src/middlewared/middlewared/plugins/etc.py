    ...
    GROUPS: MappingProxyType[str, EtcGroup] = MappingProxyType({
        ...
        'pam': EtcGroup(
            ...
            entries=(
                ...
                EtcEntry(renderer_type=RendererType.MAKO, path='pam.d/xnas-api-key'),
                EtcEntry(renderer_type=RendererType.MAKO, path='pam.d/xnas-session'),
                EtcEntry(renderer_type=RendererType.MAKO, path='pam.d/xnas-unix'),
