...
@pytest.mark.parametrize("old_version,new_version,result", [
    ...
    ("FreeNAS-11.3-U2", "X-NAS-12.0", True),
    ("FreeNAS-11.3-U2", "X-NAS-12.0-MASTER-202004190426", True),
    ("FreeNAS-11.3-U2", "X-NAS-12.0-MASTER-20200419-0426", True),
    ("FreeNAS-11.3", "X-NAS-12.0-MASTER-20200419-0426", True),
    ...
    ("X-NAS-SCALE-22.02-RC.1", "X-NAS-SCALE-22.02-MASTER-20211029-134913", True),
    # Older MASTER to newer MASTER
    ("X-NAS-SCALE-22.02-MASTER-20211029-134913", "X-NAS-SCALE-22.02-MASTER-20211029-205533", True),
    # Older INTERNAL to newer INTERNAL
    ("X-NAS-SCALE-22.02-INTERNAL-225", "X-NAS-SCALE-22.02-INTERNAL-226", True),
    # Anything can be updated to a CUSTOM build
    ("X-NAS-SCALE-22.02-RC.1", "X-NAS-SCALE-22.02-CUSTOM", True),
    ("X-NAS-SCALE-22.02-MASTER-20211029-134913", "X-NAS-SCALE-22.02-CUSTOM", True),
...
def test_can_update_internal_to_anything():
    assert can_update("X-NAS-SCALE-22.02-INTERNAL-225", "X-NAS-SCALE-22.02-RC.1")


def test_can_update_anything_to_internal():
    assert can_update("X-NAS-SCALE-22.02-RC.1", "X-NAS-SCALE-22.02-INTERNAL-225")
